...
class TrackMapRenderer(
    ...
    private var lastGeneralizedTotalPointCount: Int = -1
    ...
    fun renderTracks(
        ...
        val totalPointCount = tracks.sumOf { it.points.size }
        ...
        val pointsChangedForGeneralization = lastGeneralizedTotalPointCount != totalPointCount
        val generalizationChanged = zoomChangedForGeneralization ||
            modeChangedForGeneralization ||
            scaleChangedForGeneralization ||
            pointsChangedForGeneralization
        ...
        if (generalizationChanged) {
            ...
            lastGeneralizedTotalPointCount = totalPointCount
        }
