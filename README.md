...
- **Measurement waypoint export:** Measurement results are additionally written to a separate GPX file as `<wpt>` tags with description, coordinates, timestamp, dose rate, and CI-related fields.
